export const Icons = {
    ...
    Docker: ({ className }) => (
        <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M22 7.7V11H2.5V3.3a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1H10v1a1 1 0 1 0 2 0v-1h2a1 1 0 1 0 2 0v-1h1.7a1 1 0 0 1 1 1V5H20a1 1 0 1 0 2 0v1h1a1 1 0 0 1 1 1zM2.5 12.3V19a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-6.7H2.5z" />
        </svg>
    ),
    Storage: ({ className }) => (
        <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    Kubernetes: ({ className }) => (
        <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M12 2L3.5 7v10l8.5 5 8.5-5V7L12 2z" />
            <path d="M12 22v-6" />
            <path d="M3.5 17L12 12l8.5 5" />
    ...
    // ===== NOVÉ IKONY PRO FREE-CREDITS STRÁNKU =====
    Gift: ({ className }) => (
        <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
